...
angular.module("template/timepicker/timepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/timepicker/timepicker.html",
    ...
    "	<div class=\"timeInput\">\n" +
    "		<span class=\"control-group\" ng-class=\"{'error': invalidHours}\"><input type=\"text\" ng-model=\"hours\" ng-change=\"updateHours()\" class=\"span1 text-center color-scheme-font\" ng-mousewheel=\"incrementHours()\" ng-readonly=\"readonlyInput\" maxlength=\"2\" /></span>\n" +
    "		<span class=\"margin-left-none color-scheme-font\">:</span>\n" +
    "		<span class=\"control-group\" ng-class=\"{'error': invalidMinutes}\"><input type=\"text\" ng-model=\"minutes\" ng-change=\"updateMinutes()\" class=\"span1 text-center color-scheme-font\" ng-readonly=\"readonlyInput\" maxlength=\"2\"></span>\n" +
    "		<span ng-show=\"showMeridian\" class=\"showMeridian\"><span ng-click=\"toggleMeridian()\" class=\"color-scheme-font text-center\">{{meridian}}</button></span>\n" +
    "	</div>\n" +
    "</div>");
}]);
